...
public class ClsxTest {
	...
	public void readClsxTest() {
		...
		assertThat("First Group", is(clsx.getItem().get(0).getName()));
	...
	public void readClsxErrorTest() {
		...
		clsx.getItem().get(3).getName();
		clsx.getItem().get(1).getItem().get(3).getName();
		// item의 item에 접근할 때 익셉션이 발생해야 정상
		clsx.getItem().get(0).getItem().get(0).getItem().get(0).getName();
	}
	...
	public void writeClsxTest() {
		...
		name[0] = clsx.getName();
		name[1] = clsx.getItem().get(0).getName();
		name[2] = clsx.getItem().get(0).getItem().get(0).getName();
		name[3] = clsx.getItem().get(1).getName();
		...
		assertThat(name[1], is(clsx.getItem().get(0).getName()));
		assertThat(name[2],
				is(clsx.getItem().get(0).getItem().get(0).getName()));
		assertThat(name[3], is(clsx.getItem().get(1).getName()));
