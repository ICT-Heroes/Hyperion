...
public class Data {
	...
	public int getDataCount() {
		...
		for (int i = 0; i < length; i++) {
			ret += child.get(i).getDataCount();
		}
		return ret;
	}

	/**
	 * Root를 포함한 자기 밑의 모든 데이터 중에 몇번째 데이터를 리턴
	 */
	...
	public Data getDepend(int index) {
		return depend.get(index);
	}
	...
	public void addChild(int index, Data data) {
		child.add(index, data);
	}

	public void addDepend(Data data) {
		depend.add(data);
	}

	public void addDepend(int index, Data data) {
		depend.add(index, data);
	}
	...
	public void removeDepend(int index) {
		depend.remove(index);
	}

	public void removeDepend(Data data) {
		depend.remove(data);
	}

	public void setChild(int index, Data data) {
		child.set(index, data);
	}

	public void setDepend(int index, Data data) {
		depend.set(index, data);
	}
